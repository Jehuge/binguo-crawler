...
请以JSON数组格式返回，每条评论对应一个对象，严格按以下格式，只返回JSON数组：
[
  {{"序号":1,"有效无效":"有效","正负面":"正面","营销手段":"否","技术亮点":"是","营销点":"","技术点":"智驾FSD-反应灵敏、续航-实测820km接近官方"}},
  {{"序号":2,"有效无效":"有效","正负面":"中性","营销手段":"是","技术亮点":"否","营销点":"引导加微信领优惠、软文种草话术","技术点":""}},
  {{"序号":3,"有效无效":"无效","正负面":"中性","营销手段":"否","技术亮点":"否","营销点":"","技术点":""}}
]
/no_think"""
